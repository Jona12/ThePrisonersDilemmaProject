...
import gui.event_handlers.CustomStrategiesHandler;
...
public class ControllerCustomStrategies implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Object[] objects = {textFields, rounds_value, repeat_value, twin_value,
                random_value};
        CustomStrategiesHandler customStrategiesHandler = new CustomStrategiesHandler(objects);
        save_custom_mode.setOnAction(customStrategiesHandler);
